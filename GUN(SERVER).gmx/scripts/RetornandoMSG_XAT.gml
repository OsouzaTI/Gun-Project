...
buffer_write(buffer,buffer_string,argument0); //// Xat
buffer_write(buffer,buffer_s8,argument1); /// ID do cliente
buffer_write(buffer,buffer_string,argument2); /// Mensagem
